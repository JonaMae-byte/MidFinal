...
<head>
    ...
    <title><?php echo isAdmin() ? 'Admin' : 'Staff'; ?> Dashboard</title>
...
<body>
    <div class="dashboard-container">
        <header>
            <h1>Welcome, <?php echo isAdmin() ? 'Admin' : 'Staff'; ?>!</h1>
            <nav>
                <ul>
                    ...
                    <?php else: ?>
                        <!-- Staff can only access these pages -->
        ...
        <main>
            <section class="dashboard-summary">
                ...
                <p>Welcome to your dashboard. From here, you can <?php echo isAdmin() ? 'manage products, suppliers, stock, sales, and view reports' : 'view products, stock levels, and record sales'; ?>.</p>
